...
import com.example.wangqian.happinesshunter.adapter.TestStackAdapter;
...
public class ListActivity extends AppCompatActivity implements CardStackView.ItemExpendListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTestStackAdapter = new TestStackAdapter(this,diaryList);
        ...
        new Handler().postDelayed(
                new Runnable() {
                    @Override
                    public void run() {
                        mTestStackAdapter.updateData(diaryList);
                    }
                }
                , 200
        );
