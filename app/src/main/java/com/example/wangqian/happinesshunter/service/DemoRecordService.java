...
public class DemoRecordService implements RecordService {
    ...
    public List<Record> getRecords(String keyWord) {
        return demoRecordList.subList(1, 3);
    }
